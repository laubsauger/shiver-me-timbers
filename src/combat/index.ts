...
export { createGunnery } from './gunnery';
export type { Gunnery, GunneryConfig, GunneryView } from './gunnery';
export { clampElevation, createAim, muzzleLay, predictImpact } from './aim';
export type { Aim, AimPrediction, MuzzleLay } from './aim';
